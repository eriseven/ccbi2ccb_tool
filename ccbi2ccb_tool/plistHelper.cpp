...
void Recurse(TiXmlNode * pParentNode, CCObject * pParentObj)
{
  ...
  for (TiXmlNode * pNode = pParentNode->FirstChild(); pNode; pNode = pNode->NextSiblingElement())
  {
    ...
    if (strcmp(szValue, "key") == 0)
    {
      keyValue = szText;
    }
    else if (strcmp(szValue, "dict") == 0)
    {
    ...
    else if (strcmp(szValue, "array") == 0)
    {
    ...
    else if (strcmp(szValue, "string") == 0)
    {
    ...
    else if (strcmp(szValue, "false") == 0 || strcmp(szValue, "true") == 0)
    {
      CCBool * pBool = new CCBool(strcmp(szValue, "true") == 0);
      addObject(pParentObj, keyValue, pBool);
    }
    else if (strcmp(szValue, "integer") == 0)
    {
      CCInteger * pInt = new CCInteger(atoi(szText));
      addObject(pParentObj, keyValue, pInt);
    }
    else if (strcmp(szValue, "real") == 0)
    {
